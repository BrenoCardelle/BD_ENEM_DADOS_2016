...
arquivo1 = open("t_questao_2016_2.csv", "r")
arquivo2 = open("t_questao_2016_3.csv", "w")
...
for line in arquivo1:
    ...
    if (p[0] == '231' or p[0] == '232' or p[0] == '233' or p[0] == '234' or p[0] == '251' or p[0] == '271' or
        ...
        for i in range(91, 136):
            if i <= 95:
                b = '2016' + p[0] + str(i) + "," + p[k] + "," + p[l] + '\n'
                arquivo2.writelines(b)
                k = k + 1
                l = l + 1
            elif i >= 96:
                b = '2016' + p[0] + str(i) + "," + p[m] + '\n'
                arquivo2.writelines(b)
                m = m + 1
