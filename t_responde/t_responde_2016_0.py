...
arquivosaida = open('t_responde_2016_1.csv', 'w')
...
for linha in arquivoentrada:
    ...
    for char in T:  # Resposta da Prova de LC
        o = o + 1
        a1 = texto[0] + "," + '2016' + texto[94] + str(o) + "," + char + '\n'
        arquivosaida.writelines(a1)

    for char in texto[103]:  # Resposta da Prova de MT
        j = j + 1
        a1 = texto[0] + "," + '2016' + texto[95] + str(j) + "," + char + '\n'
        arquivosaida.writelines(a1)
